...
def _build_digest_prompt(article: ArticleForDigest, *, content_char_limit: int) -> str:
    ...
    return (
        ...
        "policy change. Category impact is impact within the article's own vertical: a legitimate sports, automotive, "
        ...
        "consequences (regulation, multi-billion market shift, security-critical, public-safety). For sports injuries "
        ...
        "profile_or_background, consumer_review, election, major_sports_event, critical_infrastructure, "
        ...
        "stresses affecting populations; do not use it for personal-health backstory in a profile, sports injuries, "
